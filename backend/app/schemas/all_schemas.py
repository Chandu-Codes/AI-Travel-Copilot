...
class TripCreateRequest(BaseModel):
    destination: str
    starting_location: Optional[str] = "Delhi, India"
    start_date: str = "2025-06-10"
...
class BudgetOptimizationRequest(BaseModel):
    ...
    travelers_count: int = 2
    duration_days: int = 5
    travel_style: str = "Mid_Range_Explorer"
...
class ChatMessage(BaseModel):
    ...
    content: str
    embedded_type: Optional[str] = None # itinerary, hotel_card, flight_card, disruption_alert
