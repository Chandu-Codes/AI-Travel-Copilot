...
print("==================================================================")
print("📈 TRAINING & EVALUATING MULTINOMIAL LOGISTIC REGRESSION (DELAY RISK)")
print("==================================================================\n")

# Recreate the exact ground truth dataset with identical seed as train_all_models.py
np.random.seed(42)
delay_samples = 15000
...
# Save model
model_path = "models/alternate_benchmarks/flight_delay_multinomial_logistic.joblib"
joblib.dump(logistic_pipeline, model_path)
print(f"✓ Multinomial Logistic Regression model saved to: {model_path}")

# Test scenarios comparing predictions
scenarios = [
    {
...
# Load RF classifier for comparison
...
case_results = []
for sc in scenarios:
    log_pred = str(logistic_pipeline.predict(sc["input"])[0])
    log_probs = {c: round(float(p), 3) for c, p in zip(logistic_pipeline.classes_, logistic_pipeline.predict_proba(sc["input"])[0])}
    ...
    case_results.append({
        ...
        "multinomial_logistic_prediction": log_pred,
        "multinomial_logistic_probabilities": log_probs,
...
eval_data = {
    ...
    "model_type": "Multinomial Logistic Regression (L-BFGS, multi_class='multinomial')",
    ...
    "classes": list(logistic_pipeline.classes_),
    "classification_report": report_dict,
    "scenario_tests": case_results,
    "file_path": model_path
}

json_path = "models/alternate_benchmarks/multinomial_logistic_evaluation.json"
with open(json_path, "w", encoding="utf-8") as f:
    json.dump(eval_data, f, indent=2)

print("\n==================================================================")
print("📊 MULTINOMIAL LOGISTIC REGRESSION EVALUATION SUMMARY")
print("==================================================================")
