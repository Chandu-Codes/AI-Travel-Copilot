...
export const WeatherPage: React.FC = () => {
  ...
  const cityOptions = ['Goa', 'Jaipur', 'Switzerland'];
    ...
    <div className="flex min-h-screen bg-[#f8fafc]">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <Navbar 
          ...
          subtitle="Forecast radars, rain probability, and AI automated indoor rerouting" 
        />

        <main className="p-8 max-w-7xl w-full space-y-6">
          {/* Destination Switcher */}
          <div className="flex items-center gap-2">
            <span className="text-xs font-bold text-slate-500 uppercase">Select Destination:</span>
            {cityOptions.map((c) => (
              <button
                key={c}
                onClick={() => {
          ...
          {weatherData && (
            <div className="space-y-6">
              ...
              {indoorReroute && (
                <div className="p-6 rounded-3xl bg-amber-50 border border-amber-200 space-y-3 shadow-xs">
                  <div className="flex items-center gap-2 text-amber-900 font-bold text-sm">
                    ...
                    <span>Weather Adaptation Advisory: High Precipitation Expected</span>
                  </div>
              ...
              <div className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-xs space-y-4">
                <h4 className="font-bold text-slate-900 text-base">5-Day Weather Outlook</h4>
